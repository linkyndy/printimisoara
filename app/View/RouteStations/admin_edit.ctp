...
<div class="row">
	<div class="span3">
		<div class="well">
			<ul class="nav nav-list">
				...
				<li><?php echo $this->Form->postLink(__('<i class="icon-trash"></i> Sterge statia'), array('action' => 'delete', $this->Form->value('Station.id')), array('escape' => false), __('Esti sigur ca vrei sa stergi statia # %s?', $this->Form->value('Station.id'))); ?></li>
	...
	<div class="span9">
		<h1>Editeaza statia: <?php echo $this->Form->value('Station.name'); ?></h1>
		<br>
