	...
	<div class="span3">
		<div class="well">
			<ul class="nav nav-list">
				...
				<li><?php echo $this->Form->postLink(__('<i class="icon-trash"></i> Sterge statia'), array('action' => 'delete', $station['Station']['id']), array('escape' => false), __('Esti sigur ca vrei sa stergi statia # %s?', $station['Station']['id'])); ?></li>
