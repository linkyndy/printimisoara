	...
	<div class="row">
		...
		<div class="span3">
			...
			<table class="table table-condensed">
				...
				<tr><td>Verificare rute in cache</td><td><?php echo round($data['time']['checkCachedRoutes'], 5); ?>s</td>
				<tr><td>Lista rutelor</td><td><?php echo round($data['time']['routeList'], 5); ?>s</td>
				<tr><td>Datele rutelor</td><td><?php echo round($data['time']['routeData'], 5); ?>s</td>
			</table>
		</div>
		<div class="span2">
