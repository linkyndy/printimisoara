<div class="stationLines index">
	<h2><?php echo __('Station Lines');?></h2>
	...
	<tr>
		<td><?php echo h($stationLine['StationLine']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($stationLine['StationLine']['order']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $stationLine['StationLine']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $stationLine['StationLine']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $stationLine['StationLine']['id']), null, __('Are you sure you want to delete # %s?', $stationLine['StationLine']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
